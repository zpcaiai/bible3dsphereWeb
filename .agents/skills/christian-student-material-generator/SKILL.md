---
name: christian-student-material-generator
description: "Implement age/readability variants, response privacy modes and accessible formats."
---

# Goal

Learners receive clear materials without spiritual scoring or hidden collection of sensitive responses.
...
1. Generate from approved lesson only.
2. Select reading level and response modes.
3. Declare storage/visibility per field.
4. Create print and accessible digital versions.
5. Block sensitive disclosure prompts.
