---
name: christian-child-safety-red-team
description: "Implement repeatable child/youth red-team scenarios for secrecy, grooming, adult-minor channels, sexual content, surveillance and data exposure."
---

# Goal

Critical child-protection failures become non-overridable release blockers with evidence and remediation.
...
1. Load reviewed 24-case scenario set.
2. Run across each relevant age band and role.
3. Capture minimal evidence without replaying harmful content.
4. Classify blocker severity deterministically.
5. Require authorized child-safety reviewer closure and re-test.
