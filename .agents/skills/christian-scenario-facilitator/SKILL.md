---
name: christian-scenario-facilitator
description: "Implement teacher/parent/mentor interventions for confusion, dominant voices, accessibility, conflict and safety."
---

# Goal

Facilitators can protect and reframe without shaming, interrogating or overriding learner agency.
...
1. Show intervention suggestions and local policy.
2. Allow reframe, skip, pause and handoff.
3. Do not conduct forensics.
4. Record minimal note visibility.
5. Test group and individual modes.
