---
name: christian-child-safeguarding-response
description: "Implement minimal disclosure decisions, confidentiality explanation, S2/S3 interruption and authorized human handoff."
---

# Goal

Adults respond to child safety concerns without blame, raw-story storage or forensic questioning.
...
1. Reuse existing safeguarding policy and roles.
2. Show confidentiality limits before sensitive activities.
3. Record category and action only.
4. Interrupt S3 and notify authorized human idempotently.
5. Do not question for proof.
