---
name: christian-child-feedback-invitation
description: "Build age-appropriate, skippable, transparent and non-retaliatory feedback from children about family experience."
---

# Goal

Children can describe ordinary experience safely without being tested for belief, forced to disclose secrets or exposed to retaliation.
...
1. Use reviewed prompt sets and age bands.
2. Show visibility and safeguarding limits before response.
3. Allow skip and not-stored option.
4. Aggregate teacher views only above privacy thresholds.
5. Do not expose responses to unauthorized adults.
