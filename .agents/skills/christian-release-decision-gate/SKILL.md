---
name: christian-release-decision-gate
description: "Implement final gate aggregation, blocker policy, limited rollout, feature flag, rollback and incident ownership."
---

# Goal

A release is approved only by an authorized human after all required current gates pass and rollback is ready.
...
1. Resolve required gates from scope.
2. Validate certificate hashes, expiry and decisions.
3. Aggregate blockers without hiding conditions.
4. Require human decision owner, incident owner and rollback.
5. Create approve, limited-rollout or reject decision and audit trail.
