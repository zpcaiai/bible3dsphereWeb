---
name: christian-family-covenant-review
description: "Implement 7/14/30/90-day review of working clauses, friction, member voice and changes without private usage analytics."
---

# Goal

The covenant adapts based on observable family experience rather than surveillance or comparison.
...
1. Load current version and unresolved items.
2. Collect coarse member feedback with visibility rules.
3. Produce keep/change/pause/retire decisions.
4. Create next version and audit diff.
5. Never generate family or member scores.
