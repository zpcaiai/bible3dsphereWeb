...
description: "管理 draft、experimental、limited、certified、deprecated、retired、revoked 及证据过期传播。 Scope: Database and Data-Platform Modernization Factory. Use when implementing, reviewing, or validating Batch 31."
---
## Package Metadata
