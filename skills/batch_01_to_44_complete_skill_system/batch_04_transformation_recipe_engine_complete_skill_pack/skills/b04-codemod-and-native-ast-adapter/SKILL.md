...
description: "利用语言原生 AST 的生态优势，同时保持范围、类型和验证边界。 Use for Batch 04 native-adapter implementation, review, or validation. Use when implementing, reviewing, or validating Batch 04."
---

# b04-codemod-and-native-ast-adapter
