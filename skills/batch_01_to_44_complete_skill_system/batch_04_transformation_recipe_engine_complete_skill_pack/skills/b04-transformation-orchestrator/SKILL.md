...
description: "把 Batch 3 IR Bundle 与方向性 Route Pack 转换为可重放、可验证、可回滚的 Signed Patch Bundle。 Use for Batch 04 orchestrator implementation, review, or validation. Use when implementing, reviewing, or validating Batch 04."
---

# b04-transformation-orchestrator
