...
description: "支持 Rename、Move、Signature Change、API Replacement 和 Adapter Introduction。 Use for Batch 04 graph-rewrite implementation, review, or validation. Use when implementing, reviewing, or validating Batch 04."
---

# b04-cross-file-symbol-api-and-graph-rewriter
...
- Batch: `batch-04`
- Capability layer: `graph-rewrite`
- Risk: `critical`
