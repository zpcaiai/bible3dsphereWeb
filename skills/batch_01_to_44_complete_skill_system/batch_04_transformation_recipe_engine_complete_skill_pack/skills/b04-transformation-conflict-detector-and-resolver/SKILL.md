...
description: "禁止 Last-write-wins，使用可交换性、优先级、Barrier 或人工选择。 Use for Batch 04 conflict-management implementation, review, or validation. Use when implementing, reviewing, or validating Batch 04."
---

# b04-transformation-conflict-detector-and-resolver
...
- Batch: `batch-04`
- Capability layer: `conflict-management`
- Risk: `critical`
