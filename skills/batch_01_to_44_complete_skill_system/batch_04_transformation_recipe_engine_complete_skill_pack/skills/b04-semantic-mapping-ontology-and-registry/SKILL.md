...
description: "明确 exact、conditional、wrapper、lossy、unsupported 和 unknown 关系。 Use for Batch 04 semantic-mapping implementation, review, or validation. Use when implementing, reviewing, or validating Batch 04."
---

# b04-semantic-mapping-ontology-and-registry
...
- Batch: `batch-04`
- Capability layer: `semantic-mapping`
- Risk: `critical`
