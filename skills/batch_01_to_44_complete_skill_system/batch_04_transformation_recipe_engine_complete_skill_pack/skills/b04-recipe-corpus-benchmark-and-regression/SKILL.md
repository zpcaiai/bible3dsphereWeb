...
description: "防止只测试成功案例、自动更新 Golden 或用格式变化冒充语义变换。 Use for Batch 04 testing implementation, review, or validation. Use when implementing, reviewing, or validating Batch 04."
---

# b04-recipe-corpus-benchmark-and-regression
