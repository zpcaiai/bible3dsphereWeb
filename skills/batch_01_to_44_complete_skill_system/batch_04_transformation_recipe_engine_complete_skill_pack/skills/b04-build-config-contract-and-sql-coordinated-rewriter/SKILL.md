...
description: "避免只改源码而遗漏依赖、连接、事务、契约和部署。 Use for Batch 04 coordinated-rewrite implementation, review, or validation. Use when implementing, reviewing, or validating Batch 04."
---

# b04-build-config-contract-and-sql-coordinated-rewriter
...
- Batch: `batch-04`
- Capability layer: `coordinated-rewrite`
- Risk: `critical`
