...
description: "利用 Compiler Fact 与 Pass Manager，同时避免无 Source Map 的 Compiler IR 结果冒充源码补丁。 Use for Batch 04 compiler-adapter implementation, review, or validation. Use when implementing, reviewing, or validating Batch 04."
---

# b04-compiler-rewrite-pass-adapter
...
- Batch: `batch-04`
- Capability layer: `compiler-adapter`
- Risk: `critical`
