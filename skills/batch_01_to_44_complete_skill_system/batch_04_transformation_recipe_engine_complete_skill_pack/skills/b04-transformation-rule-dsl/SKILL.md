...
description: "让规则显式声明适用性、读写集、分析依赖、后置条件、验证和回滚。 Use for Batch 04 rule-language implementation, review, or validation. Use when implementing, reviewing, or validating Batch 04."
---

# b04-transformation-rule-dsl
...
- Batch: `batch-04`
- Capability layer: `rule-language`
- Risk: `critical`
