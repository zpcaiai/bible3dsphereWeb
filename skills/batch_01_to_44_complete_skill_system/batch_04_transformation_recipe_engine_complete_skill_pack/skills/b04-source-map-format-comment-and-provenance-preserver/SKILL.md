...
description: "让评审者理解每个 Patch 来源，并防止 Formatter 噪声掩盖真实变更。 Use for Batch 04 provenance implementation, review, or validation. Use when implementing, reviewing, or validating Batch 04."
---

# b04-source-map-format-comment-and-provenance-preserver
