...
description: "阻止版本、IR Level、动态语义、生成代码、许可证或业务风险不满足的规则。 Use for Batch 04 applicability implementation, review, or validation. Use when implementing, reviewing, or validating Batch 04."
---

# b04-applicability-precondition-and-guard-engine
...
- Batch: `batch-04`
- Capability layer: `applicability`
- Risk: `critical`
