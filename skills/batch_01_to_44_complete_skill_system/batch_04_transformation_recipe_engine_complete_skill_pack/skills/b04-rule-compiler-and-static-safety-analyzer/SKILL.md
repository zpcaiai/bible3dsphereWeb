...
description: "在规则执行前拒绝不安全、不确定或无法界定影响范围的变换。 Use for Batch 04 rule-compiler implementation, review, or validation. Use when implementing, reviewing, or validating Batch 04."
---

# b04-rule-compiler-and-static-safety-analyzer
...
- Batch: `batch-04`
- Capability layer: `rule-compiler`
- Risk: `critical`
