...
description: "把原生 OpenRewrite 结果转换为平台 PatchSet、Evidence、Journal 和 IR 失效。 Use for Batch 04 native-adapter implementation, review, or validation. Use when implementing, reviewing, or validating Batch 04."
---

# b04-openrewrite-recipe-adapter
...
- Batch: `batch-04`
- Capability layer: `native-adapter`
- Risk: `critical`
