...
description: "提供确定性可信根，并明确 Agent-assisted 运行不具生成确定性。 Use for Batch 04 runtime implementation, review, or validation. Use when implementing, reviewing, or validating Batch 04."
---

# b04-deterministic-recipe-runtime
