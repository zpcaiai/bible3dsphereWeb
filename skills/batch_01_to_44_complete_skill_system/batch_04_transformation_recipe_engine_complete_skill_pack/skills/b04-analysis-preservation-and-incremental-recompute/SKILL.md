...
description: "防止变换后使用 Stale Analysis，同时避免无必要全量重算。 Use for Batch 04 analysis-management implementation, review, or validation. Use when implementing, reviewing, or validating Batch 04."
---

# b04-analysis-preservation-and-incremental-recompute
...
- Batch: `batch-04`
- Capability layer: `analysis-management`
- Risk: `critical`
