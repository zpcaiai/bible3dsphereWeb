...
description: "利用 Agent 处理局部胶水问题，但不让其成为可信根或扩大范围。 Use for Batch 04 agent-repair implementation, review, or validation. Use when implementing, reviewing, or validating Batch 04."
---

# b04-restricted-agent-repair-controller
