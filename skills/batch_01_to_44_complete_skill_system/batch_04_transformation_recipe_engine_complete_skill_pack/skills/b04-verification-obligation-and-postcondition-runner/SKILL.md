...
description: "建立 V0–V9 分层验证，并在无法判定时保持 inconclusive。 Use for Batch 04 verification implementation, review, or validation. Use when implementing, reviewing, or validating Batch 04."
---

# b04-verification-obligation-and-postcondition-runner
