...
description: "在写入前生成完整、可冲突分析、可回滚的 Patch Plan。 Use for Batch 04 patch-planning implementation, review, or validation. Use when implementing, reviewing, or validating Batch 04."
---

# b04-rewrite-operation-and-patch-planner
...
- Batch: `batch-04`
- Capability layer: `patch-planning`
- Risk: `critical`
