...
description: "生成稳定排序、可重放、可解释的 Match Set 与变量绑定。 Use for Batch 04 matcher implementation, review, or validation. Use when implementing, reviewing, or validating Batch 04."
---

# b04-semantic-matcher-query-and-binding
