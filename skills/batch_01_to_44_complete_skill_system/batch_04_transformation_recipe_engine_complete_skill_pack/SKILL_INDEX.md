...
- 文件：`skills/b04-transformation-orchestrator/SKILL.md`
- 层：`orchestrator`
- 风险：`critical`
...
- 文件：`skills/b04-semantic-mapping-ontology-and-registry/SKILL.md`
- 层：`semantic-mapping`
- 风险：`critical`
...
- 文件：`skills/b04-transformation-rule-dsl/SKILL.md`
- 层：`rule-language`
- 风险：`critical`
...
- 文件：`skills/b04-rule-compiler-and-static-safety-analyzer/SKILL.md`
- 层：`rule-compiler`
- 风险：`critical`
...
- 文件：`skills/b04-semantic-matcher-query-and-binding/SKILL.md`
- 层：`matcher`
- 风险：`critical`
...
- 文件：`skills/b04-applicability-precondition-and-guard-engine/SKILL.md`
- 层：`applicability`
- 风险：`critical`
...
- 文件：`skills/b04-rewrite-operation-and-patch-planner/SKILL.md`
- 层：`patch-planning`
- 风险：`critical`
...
- 文件：`skills/b04-deterministic-recipe-runtime/SKILL.md`
- 层：`runtime`
- 风险：`critical`
...
- 文件：`skills/b04-recipe-composition-pass-planner-and-explain/SKILL.md`
- 层：`planning`
- 风险：`critical`
...
- 文件：`skills/b04-analysis-preservation-and-incremental-recompute/SKILL.md`
...
- 文件：`skills/b04-directional-route-pack-builder/SKILL.md`
- 层：`route-pack`
- 风险：`critical`
...
- 文件：`skills/b04-openrewrite-recipe-adapter/SKILL.md`
- 层：`native-adapter`
- 风险：`critical`
...
- 文件：`skills/b04-codemod-and-native-ast-adapter/SKILL.md`
- 层：`native-adapter`
- 风险：`high`
...
- 文件：`skills/b04-compiler-rewrite-pass-adapter/SKILL.md`
- 层：`compiler-adapter`
- 风险：`critical`
...
- 文件：`skills/b04-cross-file-symbol-api-and-graph-rewriter/SKILL.md`
- 层：`graph-rewrite`
- 风险：`critical`
...
- 文件：`skills/b04-build-config-contract-and-sql-coordinated-rewriter/SKILL.md`
...
- 文件：`skills/b04-transformation-conflict-detector-and-resolver/SKILL.md`
...
- 文件：`skills/b04-copy-on-write-transaction-and-rollback/SKILL.md`
- 层：`transaction`
- 风险：`critical`
...
- 文件：`skills/b04-source-map-format-comment-and-provenance-preserver/SKILL.md`
- 层：`provenance`
- 风险：`high`
...
- 文件：`skills/b04-verification-obligation-and-postcondition-runner/SKILL.md`
- 层：`verification`
- 风险：`critical`
...
- 文件：`skills/b04-restricted-agent-repair-controller/SKILL.md`
- 层：`agent-repair`
- 风险：`critical`
...
- 文件：`skills/b04-agent-repair-to-rule-distiller/SKILL.md`
- 层：`rule-learning`
- 风险：`high`
...
- 文件：`skills/b04-recipe-package-registry-and-supply-chain/SKILL.md`
- 层：`registry`
- 风险：`critical`
...
- 文件：`skills/b04-recipe-corpus-benchmark-and-regression/SKILL.md`
- 层：`testing`
- 风险：`critical`
...
- 文件：`skills/b04-transformation-certification-gate/SKILL.md`
- 层：`certification`
- 风险：`critical`
