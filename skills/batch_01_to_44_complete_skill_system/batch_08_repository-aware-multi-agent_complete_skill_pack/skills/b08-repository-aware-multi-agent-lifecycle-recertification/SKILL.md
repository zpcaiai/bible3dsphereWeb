...
description: "管理 draft、experimental、limited、certified、deprecated、retired、revoked 及证据过期传播。 Scope: Repository-Aware Multi-Agent, Context and RAG System. Use when implementing, reviewing, or validating Batch 08."
---
## Package Metadata
