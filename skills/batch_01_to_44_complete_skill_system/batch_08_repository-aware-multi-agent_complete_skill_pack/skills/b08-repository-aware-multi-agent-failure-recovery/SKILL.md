...
description: "分类失败、隔离影响、保存证据、回滚到安全点、恢复运行并阻止假成功。 Scope: Repository-Aware Multi-Agent, Context and RAG System. Use when implementing, reviewing, or validating Batch 08."
---
## Package Metadata
