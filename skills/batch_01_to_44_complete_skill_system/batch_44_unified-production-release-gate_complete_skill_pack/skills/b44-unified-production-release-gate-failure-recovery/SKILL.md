...
description: "分类失败、隔离影响、保存证据、回滚到安全点、恢复运行并阻止假成功。 Scope: Unified Production Release Gate and Continuous Recertification. Use when implementing, reviewing, or validating Batch 44."
---
## Package Metadata
