...
description: "定义稳定 ID、版本化 Schema、状态、输入输出、Unknown 保留、摘要和兼容策略。 Scope: Unified Production Release Gate and Continuous Recertification. Use when implementing, reviewing, or validating Batch 44."
---
## Package Metadata
