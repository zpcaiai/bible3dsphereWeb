...
description: "管理 draft、experimental、limited、certified、deprecated、retired、revoked 及证据过期传播。 Scope: Unified Production Release Gate and Continuous Recertification. Use when implementing, reviewing, or validating Batch 44."
---
## Package Metadata
