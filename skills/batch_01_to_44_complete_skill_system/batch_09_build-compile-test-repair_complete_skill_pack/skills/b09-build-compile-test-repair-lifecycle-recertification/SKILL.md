...
description: "管理 draft、experimental、limited、certified、deprecated、retired、revoked 及证据过期传播。 Scope: Build, Compile, Test Repair and Bounded Fix Loop. Use when implementing, reviewing, or validating Batch 09."
---
## Package Metadata
