...
description: "生成当前架构、Drift、迁移单元候选和假设登记。 Use for Batch 02 architecture implementation, review, or validation. Use when implementing, reviewing, or validating Batch 02."
---

# b02-architecture-recovery-engine
