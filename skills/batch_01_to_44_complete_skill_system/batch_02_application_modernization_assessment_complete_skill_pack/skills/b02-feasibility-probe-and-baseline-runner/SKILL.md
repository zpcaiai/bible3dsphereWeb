...
description: "用真实工具链证据校准候选，而不把探针通过冒充生产迁移成功。 Use for Batch 02 experimental-validation implementation, review, or validation. Use when implementing, reviewing, or validating Batch 02."
---

# b02-feasibility-probe-and-baseline-runner
...
- Batch: `batch-02`
- Capability layer: `experimental-validation`
- Risk: `critical`
