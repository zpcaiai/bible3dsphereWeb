...
description: "识别静态与运行差异、Hot Path、采样限制和生产基线。 Use for Batch 02 runtime-analysis implementation, review, or validation. Use when implementing, reviewing, or validating Batch 02."
---

# b02-runtime-topology-correlator
...
- Batch: `batch-02`
- Capability layer: `runtime-analysis`
- Risk: `high`
