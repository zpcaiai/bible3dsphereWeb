...
description: "输出 Pareto 候选，而不是单一 AI 推荐，并显式保留被淘汰方案。 Use for Batch 02 planning implementation, review, or validation. Use when implementing, reviewing, or validating Batch 02."
---

# b02-migration-strategy-route-candidate-generator
