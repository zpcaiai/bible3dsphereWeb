...
description: "把代码以外的运行与组织证据纳入同一评估快照。 Use for Batch 02 discovery implementation, review, or validation. Use when implementing, reviewing, or validating Batch 02."
---

# b02-infrastructure-runtime-document-ingestion
