...
description: "为架构、依赖和路线评估提供可查询的源语义基础。 Use for Batch 02 semantic-analysis implementation, review, or validation. Use when implementing, reviewing, or validating Batch 02."
---

# b02-semantic-source-indexer
...
- Batch: `batch-02`
- Capability layer: `semantic-analysis`
- Risk: `critical`
