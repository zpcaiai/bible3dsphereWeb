...
description: "建立 Source→Artifact→Deployment→Runtime 与业务系统层级的统一身份。 Use for Batch 02 normalization implementation, review, or validation. Use when implementing, reviewing, or validating Batch 02."
---

# b02-canonical-workload-inventory-builder
...
- Batch: `batch-02`
- Capability layer: `normalization`
- Risk: `critical`
