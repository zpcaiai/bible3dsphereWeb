...
description: "让 Pilot、平台前置、共享数据库和高关键系统按依赖和学习价值排序。 Use for Batch 02 portfolio-planning implementation, review, or validation. Use when implementing, reviewing, or validating Batch 02."
---

# b02-portfolio-prioritization-wave-planner
...
- Batch: `batch-02`
- Capability layer: `portfolio-planning`
- Risk: `critical`
