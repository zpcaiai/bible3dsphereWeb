...
description: "区分迁移前必须修复、迁移中处理和迁移后偿还的技术债。 Use for Batch 02 risk-analysis implementation, review, or validation. Use when implementing, reviewing, or validating Batch 02."
---

# b02-technical-debt-maintainability-assessor
...
- Batch: `batch-02`
- Capability layer: `risk-analysis`
- Risk: `high`
