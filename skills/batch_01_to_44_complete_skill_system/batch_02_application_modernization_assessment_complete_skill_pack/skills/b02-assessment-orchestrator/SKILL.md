...
description: "保证发现、架构恢复、风险分析、路线候选、探针、预测和证书围绕同一 Snapshot 与证据链运行。 Use for Batch 02 orchestrator implementation, review, or validation. Use when implementing, reviewing, or validating Batch 02."
---

# b02-assessment-orchestrator
