...
description: "发现生产中存在但源码中缺失或版本不一致的组件。 Use for Batch 02 discovery implementation, review, or validation. Use when implementing, reviewing, or validating Batch 02."
---

# b02-binary-and-artifact-discovery
