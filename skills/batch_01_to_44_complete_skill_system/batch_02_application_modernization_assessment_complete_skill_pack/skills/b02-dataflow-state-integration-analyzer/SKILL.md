...
description: "建立应用与数据库联合迁移、差分验证和 Dual Run 所需的可观测面。 Use for Batch 02 data-analysis implementation, review, or validation. Use when implementing, reviewing, or validating Batch 02."
---

# b02-dataflow-state-integration-analyzer
...
- Batch: `batch-02`
- Capability layer: `data-analysis`
- Risk: `critical`
