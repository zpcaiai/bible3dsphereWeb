...
description: "防止先选云产品再反向制造需求，并量化 Lock-in 与退出成本。 Use for Batch 02 target-assessment implementation, review, or validation. Use when implementing, reviewing, or validating Batch 02."
---

# b02-cloud-platform-fit-analyzer
...
- Batch: `batch-02`
- Capability layer: `target-assessment`
- Risk: `critical`
