...
- 文件：`skills/b02-assessment-orchestrator/SKILL.md`
- 层：`orchestrator`
- 风险：`critical`
...
- 文件：`skills/b02-portfolio-intake-and-scope/SKILL.md`
- 层：`intake`
- 风险：`high`
...
- 文件：`skills/b02-assessment-access-and-data-governance/SKILL.md`
- 层：`governance`
- 风险：`critical`
...
- 文件：`skills/b02-source-repository-discovery/SKILL.md`
- 层：`discovery`
- 风险：`high`
...
- 文件：`skills/b02-binary-and-artifact-discovery/SKILL.md`
- 层：`discovery`
- 风险：`critical`
...
- 文件：`skills/b02-infrastructure-runtime-document-ingestion/SKILL.md`
- 层：`discovery`
- 风险：`critical`
...
- 文件：`skills/b02-canonical-workload-inventory-builder/SKILL.md`
- 层：`normalization`
- 风险：`critical`
...
- 文件：`skills/b02-assessment-evidence-quality-controller/SKILL.md`
- 层：`evidence`
- 风险：`critical`
...
- 文件：`skills/b02-semantic-source-indexer/SKILL.md`
- 层：`semantic-analysis`
- 风险：`critical`
...
- 文件：`skills/b02-architecture-recovery-engine/SKILL.md`
- 层：`architecture`
- 风险：`critical`
...
- 文件：`skills/b02-dependency-callgraph-impact-analyzer/SKILL.md`
...
- 文件：`skills/b02-dataflow-state-integration-analyzer/SKILL.md`
- 层：`data-analysis`
- 风险：`critical`
...
- 文件：`skills/b02-runtime-topology-correlator/SKILL.md`
- 层：`runtime-analysis`
- 风险：`high`
...
- 文件：`skills/b02-technical-debt-maintainability-assessor/SKILL.md`
- 层：`risk-analysis`
- 风险：`high`
...
- 文件：`skills/b02-security-supply-chain-compliance-assessor/SKILL.md`
- 层：`security`
- 风险：`critical`
...
- 文件：`skills/b02-cloud-platform-fit-analyzer/SKILL.md`
- 层：`target-assessment`
- 风险：`critical`
...
- 文件：`skills/b02-migration-strategy-route-candidate-generator/SKILL.md`
- 层：`planning`
- 风险：`critical`
...
- 文件：`skills/b02-feasibility-probe-and-baseline-runner/SKILL.md`
...
- 文件：`skills/b02-prediction-calibration-engine/SKILL.md`
- 层：`prediction`
- 风险：`critical`
...
- 文件：`skills/b02-portfolio-prioritization-wave-planner/SKILL.md`
...
- 文件：`skills/b02-assessment-report-and-certificate-gate/SKILL.md`
- 层：`certification`
- 风险：`critical`
