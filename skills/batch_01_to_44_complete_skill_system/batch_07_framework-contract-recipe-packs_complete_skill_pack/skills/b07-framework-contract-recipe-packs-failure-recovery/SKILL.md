...
description: "分类失败、隔离影响、保存证据、回滚到安全点、恢复运行并阻止假成功。 Scope: Framework Contract Model and Framework Migration Recipe Packs. Use when implementing, reviewing, or validating Batch 07."
---
## Package Metadata
