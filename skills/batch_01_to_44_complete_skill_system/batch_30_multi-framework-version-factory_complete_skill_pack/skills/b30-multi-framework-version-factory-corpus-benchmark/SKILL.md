...
description: "建设正例、负例、边界、Holdout、代表性和对抗性 Corpus，并执行基准和回归。 Scope: Multi-Framework and Version Migration Factory. Use when implementing, reviewing, or validating Batch 30."
---
## Package Metadata
