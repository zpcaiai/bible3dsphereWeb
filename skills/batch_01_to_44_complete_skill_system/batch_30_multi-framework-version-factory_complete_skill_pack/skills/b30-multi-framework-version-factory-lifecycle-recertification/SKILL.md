...
description: "管理 draft、experimental、limited、certified、deprecated、retired、revoked 及证据过期传播。 Scope: Multi-Framework and Version Migration Factory. Use when implementing, reviewing, or validating Batch 30."
---
## Package Metadata
