...
description: "从源码、制品、运行、配置、文档和人工声明中发现资产，保存分母、来源和未知项。 Scope: Production Observability, SLO, Incident, HA/DR and Operations Readiness. Use when implementing, reviewing, or validating Batch 42."
---
## Package Metadata
