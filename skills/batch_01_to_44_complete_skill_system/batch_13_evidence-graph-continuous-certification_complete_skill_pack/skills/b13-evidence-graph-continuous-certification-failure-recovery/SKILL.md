...
description: "分类失败、隔离影响、保存证据、回滚到安全点、恢复运行并阻止假成功。 Scope: Evidence Graph, Independent Oracle and Continuous Certification. Use when implementing, reviewing, or validating Batch 13."
---
## Package Metadata
