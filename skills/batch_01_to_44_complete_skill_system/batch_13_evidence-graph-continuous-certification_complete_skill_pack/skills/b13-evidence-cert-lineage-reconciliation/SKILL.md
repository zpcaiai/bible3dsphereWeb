---
name: b13-evidence-cert-lineage-reconciliation
description: "连接输入、决策、变换、输出、验证和证书，处理差异、冲突、重放和对账。 Scope: Evidence Graph, Independent Oracle and Continuous Certification. Use when implementing, reviewing, or validating Batch 13."
---
## Package Metadata
