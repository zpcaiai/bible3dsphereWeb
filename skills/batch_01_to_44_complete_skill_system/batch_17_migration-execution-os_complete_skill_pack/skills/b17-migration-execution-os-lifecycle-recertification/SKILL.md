...
description: "管理 draft、experimental、limited、certified、deprecated、retired、revoked 及证据过期传播。 Scope: Migration Execution Operating System. Use when implementing, reviewing, or validating Batch 17."
---
## Package Metadata
