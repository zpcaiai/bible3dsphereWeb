...
description: "连接输入、决策、变换、输出、验证和证书，处理差异、冲突、重放和对账。 Scope: Dual Run, Shadow Execution and State Reconciliation. Use when implementing, reviewing, or validating Batch 26."
---
## Package Metadata
