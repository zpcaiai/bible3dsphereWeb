...
description: "分类失败、隔离影响、保存证据、回滚到安全点、恢复运行并阻止假成功。 Scope: Dual Run, Shadow Execution and State Reconciliation. Use when implementing, reviewing, or validating Batch 26."
---
## Package Metadata
