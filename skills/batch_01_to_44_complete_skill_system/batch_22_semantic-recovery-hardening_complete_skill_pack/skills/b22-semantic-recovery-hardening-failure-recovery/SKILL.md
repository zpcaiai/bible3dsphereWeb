...
description: "分类失败、隔离影响、保存证据、回滚到安全点、恢复运行并阻止假成功。 Scope: Semantic Recovery Hardening and Runtime-Enriched CSIR. Use when implementing, reviewing, or validating Batch 22."
---
## Package Metadata
