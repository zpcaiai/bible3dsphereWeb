...
description: "实现可重放、稳定排序、内容寻址、幂等和有界执行的确定性核心。 Scope: Semantic Recovery Hardening and Runtime-Enriched CSIR. Use when implementing, reviewing, or validating Batch 22."
---
## Package Metadata
