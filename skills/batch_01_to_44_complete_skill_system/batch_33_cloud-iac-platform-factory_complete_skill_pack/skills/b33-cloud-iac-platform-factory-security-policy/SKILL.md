...
description: "落实默认拒绝、最小权限、租户隔离、Secret、供应链、隐私和策略执行。 Scope: Cloud, IaC, Container and Platform Modernization Factory. Use when implementing, reviewing, or validating Batch 33."
---
## Package Metadata
