...
description: "建设正例、负例、边界、Holdout、代表性和对抗性 Corpus，并执行基准和回归。 Scope: 72 Directional Executable Generator Packs. Use when implementing, reviewing, or validating Batch 19."
---
## Package Metadata
