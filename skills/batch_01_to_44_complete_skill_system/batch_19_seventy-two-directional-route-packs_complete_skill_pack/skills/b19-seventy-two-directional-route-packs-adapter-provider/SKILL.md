...
description: "通过签名适配器连接语言、框架、数据库、云、工具或外部 Provider，保留能力边界。 Scope: 72 Directional Executable Generator Packs. Use when implementing, reviewing, or validating Batch 19."
---
## Package Metadata
