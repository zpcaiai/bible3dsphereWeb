...
description: "定义稳定 ID、版本化 Schema、状态、输入输出、Unknown 保留、摘要和兼容策略。 Scope: 72 Directional Executable Generator Packs. Use when implementing, reviewing, or validating Batch 19."
---
## Package Metadata
