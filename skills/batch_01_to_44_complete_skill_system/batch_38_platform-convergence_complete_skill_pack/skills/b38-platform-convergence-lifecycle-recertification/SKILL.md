...
description: "管理 draft、experimental、limited、certified、deprecated、retired、revoked 及证据过期传播。 Scope: Canonical CapabilityPackage, Dependency Graph and Platform Convergence. Use when implementing, reviewing, or validating Batch 38."
---
## Package Metadata
