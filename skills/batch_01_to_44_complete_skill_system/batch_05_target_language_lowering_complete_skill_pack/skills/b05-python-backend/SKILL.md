...
description: "Implement python backend as a deterministic, evidence-bound Batch 05 target-generation capability. Use for Batch 05 language-backend implementation, review, or validation. Use when implementing, reviewing, or validating Batch 05."
---
...
Implement python backend as a deterministic, evidence-bound Batch 05 target-generation capability.
