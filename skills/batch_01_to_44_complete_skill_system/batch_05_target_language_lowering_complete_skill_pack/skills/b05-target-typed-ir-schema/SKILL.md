...
description: "Implement target typed ir schema as a deterministic, evidence-bound Batch 05 target-generation capability. Use for Batch 05 target-ir implementation, review, or validation. Use when implementing, reviewing, or validating Batch 05."
---

# b05-target-typed-ir-schema

## Objective

Implement target typed ir schema as a deterministic, evidence-bound Batch 05 target-generation capability.

## Scope

- Batch: `batch-05`
- Capability layer: `target-ir`
- Risk: `critical`
