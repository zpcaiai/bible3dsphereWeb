...
description: "Implement generated project completeness and certification gate as a deterministic, evidence-bound Batch 05 target-generation capability. Use for Batch 05 certification implementation, review, or validation. Use when implementing, reviewing, or validating Batch 05."
---

# b05-generated-project-completeness-and-certification-gate

## Objective

Implement generated project completeness and certification gate as a deterministic, evidence-bound Batch 05 target-generation capability.

## Scope

- Batch: `batch-05`
- Capability layer: `certification`
- Risk: `critical`
