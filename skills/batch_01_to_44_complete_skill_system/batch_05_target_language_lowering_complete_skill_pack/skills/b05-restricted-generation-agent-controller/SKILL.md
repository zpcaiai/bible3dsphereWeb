...
description: "Implement restricted generation agent controller as a deterministic, evidence-bound Batch 05 target-generation capability. Use for Batch 05 agent-repair implementation, review, or validation. Use when implementing, reviewing, or validating Batch 05."
---

# b05-restricted-generation-agent-controller

## Objective

Implement restricted generation agent controller as a deterministic, evidence-bound Batch 05 target-generation capability.

## Scope

- Batch: `batch-05`
- Capability layer: `agent-repair`
- Risk: `critical`
