...
description: "Implement type nullability generics and numeric lowerer as a deterministic, evidence-bound Batch 05 target-generation capability. Use for Batch 05 semantic-lowering implementation, review, or validation. Use when implementing, reviewing, or validating Batch 05."
---

# b05-type-nullability-generics-and-numeric-lowerer

## Objective

Implement type nullability generics and numeric lowerer as a deterministic, evidence-bound Batch 05 target-generation capability.

## Scope

- Batch: `batch-05`
- Capability layer: `semantic-lowering`
- Risk: `critical`
