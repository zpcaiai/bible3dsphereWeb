...
description: "Implement idiom policy and pattern selector as a deterministic, evidence-bound Batch 05 target-generation capability. Use for Batch 05 idiom-selection implementation, review, or validation. Use when implementing, reviewing, or validating Batch 05."
---

# b05-idiom-policy-and-pattern-selector

## Objective

Implement idiom policy and pattern selector as a deterministic, evidence-bound Batch 05 target-generation capability.

## Scope

- Batch: `batch-05`
- Capability layer: `idiom-selection`
- Risk: `high`
