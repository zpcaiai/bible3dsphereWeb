...
description: "Implement build lint typecheck repair loop as a deterministic, evidence-bound Batch 05 target-generation capability. Use for Batch 05 build-verification implementation, review, or validation. Use when implementing, reviewing, or validating Batch 05."
---

# b05-build-lint-typecheck-repair-loop

## Objective

Implement build lint typecheck repair loop as a deterministic, evidence-bound Batch 05 target-generation capability.

## Scope

- Batch: `batch-05`
- Capability layer: `build-verification`
- Risk: `critical`
