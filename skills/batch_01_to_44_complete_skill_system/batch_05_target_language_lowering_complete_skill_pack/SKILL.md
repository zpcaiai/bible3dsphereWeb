---
name: batch-05-target-code-generation
description: "将 Batch 4 的 Transformed CSIR 与 Target Construction Intent 降低为 Java、C#、Node.js/TypeScript、Python、C++、Go、Rust、Vue、React、Flutter 等目标语言与框架的可构建、可维护、符合目标生态习惯的完整工程代码。 Use when orchestrating, implementing, reviewing, or validating Batch 05."
---
## Package Resources
