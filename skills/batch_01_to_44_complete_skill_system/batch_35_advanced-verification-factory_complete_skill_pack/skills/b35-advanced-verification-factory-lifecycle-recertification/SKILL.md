...
description: "管理 draft、experimental、limited、certified、deprecated、retired、revoked 及证据过期传播。 Scope: Advanced Verification, Fuzzing, Mutation and Formal Assurance Factory. Use when implementing, reviewing, or validating Batch 35."
---
## Package Metadata
