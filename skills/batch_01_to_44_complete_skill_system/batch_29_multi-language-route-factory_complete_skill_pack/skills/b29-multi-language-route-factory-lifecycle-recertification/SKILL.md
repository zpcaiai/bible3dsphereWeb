...
description: "管理 draft、experimental、limited、certified、deprecated、retired、revoked 及证据过期传播。 Scope: Multi-Language Route Certification Factory. Use when implementing, reviewing, or validating Batch 29."
---
## Package Metadata
