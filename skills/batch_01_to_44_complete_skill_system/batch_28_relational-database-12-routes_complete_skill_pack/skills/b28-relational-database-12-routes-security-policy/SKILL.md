...
description: "落实默认拒绝、最小权限、租户隔离、Secret、供应链、隐私和策略执行。 Scope: Oracle, SQL Server, MySQL and PostgreSQL 12 Directional Route Packs. Use when implementing, reviewing, or validating Batch 28."
---
## Package Metadata
