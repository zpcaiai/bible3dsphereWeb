...
description: "连接输入、决策、变换、输出、验证和证书，处理差异、冲突、重放和对账。 Scope: Oracle, SQL Server, MySQL and PostgreSQL 12 Directional Route Packs. Use when implementing, reviewing, or validating Batch 28."
---
## Package Metadata
