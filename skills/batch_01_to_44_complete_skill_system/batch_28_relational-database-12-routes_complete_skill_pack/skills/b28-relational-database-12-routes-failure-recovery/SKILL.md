...
description: "分类失败、隔离影响、保存证据、回滚到安全点、恢复运行并阻止假成功。 Scope: Oracle, SQL Server, MySQL and PostgreSQL 12 Directional Route Packs. Use when implementing, reviewing, or validating Batch 28."
---
## Package Metadata
