...
description: "Implement the complete Batch 06 skill system for Standard Library, Dependency Mapping and Compatibility Runtime. Use when orchestrating, implementing, reviewing, or validating Batch 06."
---
## Package Resources
...
3. `$b06-stdlib-dependency-discovery-inventory`
4. `$b06-stdlib-dependency-capability-planning`
5. `$b06-stdlib-dependency-deterministic-engine`
...
8. `$b06-stdlib-dependency-lineage-reconciliation`
...
11. `$b06-stdlib-dependency-observability-economics`
...
15. `$b06-stdlib-dependency-lifecycle-recertification`
