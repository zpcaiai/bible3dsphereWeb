---
name: b06-stdlib-dependency-lineage-reconciliation
description: "连接输入、决策、变换、输出、验证和证书，处理差异、冲突、重放和对账。 Scope: Standard Library, Dependency Mapping and Compatibility Runtime. Use when implementing, reviewing, or validating Batch 06."
---
## Package Metadata
