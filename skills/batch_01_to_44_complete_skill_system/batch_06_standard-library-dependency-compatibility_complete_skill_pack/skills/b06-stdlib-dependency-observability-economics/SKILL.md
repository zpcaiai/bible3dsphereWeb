---
name: b06-stdlib-dependency-observability-economics
description: "采集日志、Trace、指标、分母、SLO、资源、成本、人工工时和商业可行性。 Scope: Standard Library, Dependency Mapping and Compatibility Runtime. Use when implementing, reviewing, or validating Batch 06."
---
## Package Metadata
