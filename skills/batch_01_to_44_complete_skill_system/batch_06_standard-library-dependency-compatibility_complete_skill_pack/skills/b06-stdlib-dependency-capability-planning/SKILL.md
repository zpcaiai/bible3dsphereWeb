---
name: b06-stdlib-dependency-capability-planning
description: "建立能力矩阵、候选方案、约束、依赖、优先级、成本与执行计划。 Scope: Standard Library, Dependency Mapping and Compatibility Runtime. Use when implementing, reviewing, or validating Batch 06."
---
## Package Metadata
