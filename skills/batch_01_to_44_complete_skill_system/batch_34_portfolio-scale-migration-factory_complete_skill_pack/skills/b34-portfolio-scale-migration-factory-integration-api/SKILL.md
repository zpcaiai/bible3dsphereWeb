...
description: "提供版本化 API、事件、Webhook、SDK 和导入导出，保证幂等、鉴权和兼容。 Scope: Portfolio-Scale Multi-Repository Migration Factory. Use when implementing, reviewing, or validating Batch 34."
---
## Package Metadata
