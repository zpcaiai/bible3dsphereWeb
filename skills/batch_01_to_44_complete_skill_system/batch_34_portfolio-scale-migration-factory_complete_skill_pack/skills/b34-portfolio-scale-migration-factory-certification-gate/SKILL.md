...
description: "只依据不可变证据签发最强可证明状态；缺证据、未知或阻断项必须降级或拒绝。 Scope: Portfolio-Scale Multi-Repository Migration Factory. Use when implementing, reviewing, or validating Batch 34."
---
## Package Metadata
