...
description: "落实默认拒绝、最小权限、租户隔离、Secret、供应链、隐私和策略执行。 Scope: Portfolio-Scale Multi-Repository Migration Factory. Use when implementing, reviewing, or validating Batch 34."
---
## Package Metadata
