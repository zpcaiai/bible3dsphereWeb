...
description: "管理 draft、experimental、limited、certified、deprecated、retired、revoked 及证据过期传播。 Scope: Behavioral Equivalence Gate and Independent Oracle System. Use when implementing, reviewing, or validating Batch 25."
---
## Package Metadata
