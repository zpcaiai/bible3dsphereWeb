...
description: "只依据不可变证据签发最强可证明状态；缺证据、未知或阻断项必须降级或拒绝。 Scope: Extension SDK, Marketplace and Supply-Chain Governance. Use when implementing, reviewing, or validating Batch 37."
---
## Package Metadata
