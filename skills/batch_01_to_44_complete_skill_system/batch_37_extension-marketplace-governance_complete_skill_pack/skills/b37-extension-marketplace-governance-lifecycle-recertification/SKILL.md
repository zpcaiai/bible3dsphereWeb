...
description: "管理 draft、experimental、limited、certified、deprecated、retired、revoked 及证据过期传播。 Scope: Extension SDK, Marketplace and Supply-Chain Governance. Use when implementing, reviewing, or validating Batch 37."
---
## Package Metadata
