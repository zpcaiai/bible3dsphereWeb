---
name: batch-03-canonical-semantic-ir
description: "把多语言源码、构建、配置、SQL、API、二进制和运行元数据转化为无损、可追溯、可增量、可查询和可形式化的联邦式语义 IR。 Use when orchestrating, implementing, reviewing, or validating Batch 03."
---
## Package Resources
