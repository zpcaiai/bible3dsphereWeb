...
description: "建立实现与正式契约的统一 ContractIR 和 Drift。 Use for Batch 03 contract-ir implementation, review, or validation. Use when implementing, reviewing, or validating Batch 03."
---

# b03-api-message-and-contract-ir-builder
