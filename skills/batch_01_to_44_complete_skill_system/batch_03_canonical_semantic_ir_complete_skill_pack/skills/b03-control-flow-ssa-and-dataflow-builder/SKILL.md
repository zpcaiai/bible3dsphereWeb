...
description: "为验证、优化、差分和形式化提供控制与数据语义。 Use for Batch 03 analysis-graph implementation, review, or validation. Use when implementing, reviewing, or validating Batch 03."
---

# b03-control-flow-ssa-and-dataflow-builder
...
- Batch: `batch-03`
- Capability layer: `analysis-graph`
- Risk: `critical`
