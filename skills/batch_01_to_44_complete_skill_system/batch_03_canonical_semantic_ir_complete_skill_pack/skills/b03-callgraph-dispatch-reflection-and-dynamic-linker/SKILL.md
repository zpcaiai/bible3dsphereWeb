...
description: "建立 must、may、observed 和 unresolved 调用边。 Use for Batch 03 call-analysis implementation, review, or validation. Use when implementing, reviewing, or validating Batch 03."
---

# b03-callgraph-dispatch-reflection-and-dynamic-linker
...
- Batch: `batch-03`
- Capability layer: `call-analysis`
- Risk: `critical`
