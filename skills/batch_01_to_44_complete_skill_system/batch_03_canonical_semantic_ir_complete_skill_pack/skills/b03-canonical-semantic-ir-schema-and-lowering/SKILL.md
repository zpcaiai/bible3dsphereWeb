...
description: "用共同语义支持跨语言比较，同时通过 Extension Capsule 保留专有语义。 Use for Batch 03 canonical-ir implementation, review, or validation. Use when implementing, reviewing, or validating Batch 03."
---

# b03-canonical-semantic-ir-schema-and-lowering
