...
description: "让后续 Batch 通过稳定 API 消费 IR，而不是直接读取内部存储。 Use for Batch 03 ir-service implementation, review, or validation. Use when implementing, reviewing, or validating Batch 03."
---

# b03-ir-query-diff-and-export-service
