...
description: "区分可形式化区域、边界假设、Unsupported Semantics 和已经完成的证明。 Use for Batch 03 formal-foundation implementation, review, or validation. Use when implementing, reviewing, or validating Batch 03."
---

# b03-formalizable-core-and-proof-obligation-contract
...
- Batch: `batch-03`
- Capability layer: `formal-foundation`
- Risk: `critical`
