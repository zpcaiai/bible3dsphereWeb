...
description: "确保跨语言转换不会因参数、操作数、闭包或 Await 顺序差异改变行为。 Use for Batch 03 semantic-lowering implementation, review, or validation. Use when implementing, reviewing, or validating Batch 03."
---

# b03-expression-statement-and-evaluation-order-lowerer
