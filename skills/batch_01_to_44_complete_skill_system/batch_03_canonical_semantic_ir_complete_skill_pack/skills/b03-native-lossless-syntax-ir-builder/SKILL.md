...
description: "提供文本与语言原生结构的保真层，支持无操作 Round Trip 和最小范围重写。 Use for Batch 03 native-ir implementation, review, or validation. Use when implementing, reviewing, or validating Batch 03."
---

# b03-native-lossless-syntax-ir-builder
