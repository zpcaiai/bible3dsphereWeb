...
description: "统一 Compiler-backed、Lossless、Syntax 和 Token Fallback 前端，而不强制使用同一解析器。 Use for Batch 03 frontend-platform implementation, review, or validation. Use when implementing, reviewing, or validating Batch 03."
---

# b03-frontend-adapter-sdk-and-registry
...
- Batch: `batch-03`
- Capability layer: `frontend-platform`
- Risk: `critical`
