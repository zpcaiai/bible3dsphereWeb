...
description: "为 Assessment Snapshot 生成唯一、可复现、可恢复的联邦式 IR Bundle。 Use for Batch 03 orchestrator implementation, review, or validation. Use when implementing, reviewing, or validating Batch 03."
---

# b03-ir-foundation-orchestrator
