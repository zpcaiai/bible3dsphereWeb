...
description: "提供一对多、多对一、Tombstone 和跨快照语义候选匹配。 Use for Batch 03 traceability implementation, review, or validation. Use when implementing, reviewing, or validating Batch 03."
---

# b03-source-map-provenance-and-semantic-fingerprint
