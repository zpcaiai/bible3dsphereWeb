...
description: "避免全仓重算，同时确保不同 Build Context、Frontend 和 Schema 之间不误复用。 Use for Batch 03 ir-runtime implementation, review, or validation. Use when implementing, reviewing, or validating Batch 03."
---

# b03-incremental-ir-cache-and-chunk-store
