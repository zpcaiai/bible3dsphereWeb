...
description: "形成 Compiler-confirmed 与 Partial Semantic Facts，防止模型猜测污染。 Use for Batch 03 native-semantics implementation, review, or validation. Use when implementing, reviewing, or validating Batch 03."
---

# b03-native-semantic-attribution-engine
...
- Batch: `batch-03`
- Capability layer: `native-semantics`
- Risk: `critical`
