...
description: "提供稳定 SymbolId、LogicalSymbolId 和模糊引用模型。 Use for Batch 03 semantic-linking implementation, review, or validation. Use when implementing, reviewing, or validating Batch 03."
---

# b03-symbol-identity-scope-and-linker
...
- Batch: `batch-03`
- Capability layer: `semantic-linking`
- Risk: `critical`
