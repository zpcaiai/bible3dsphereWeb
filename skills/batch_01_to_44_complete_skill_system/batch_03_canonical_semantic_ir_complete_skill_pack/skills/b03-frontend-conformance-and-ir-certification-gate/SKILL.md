...
description: "通过 IR0–IR6 分资产认证，防止局部语义能力冒充全仓完整语义。 Use for Batch 03 certification implementation, review, or validation. Use when implementing, reviewing, or validating Batch 03."
---

# b03-frontend-conformance-and-ir-certification-gate
