...
description: "让同一源码在不同 Profile、Target Framework、宏和依赖下拥有独立语义上下文。 Use for Batch 03 build-semantics implementation, review, or validation. Use when implementing, reviewing, or validating Batch 03."
---

# b03-build-context-and-toolchain-resolver
...
- Batch: `batch-03`
- Capability layer: `build-semantics`
- Risk: `critical`
