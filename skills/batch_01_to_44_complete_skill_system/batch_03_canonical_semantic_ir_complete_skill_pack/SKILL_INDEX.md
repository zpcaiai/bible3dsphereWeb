...
- 文件：`skills/b03-ir-foundation-orchestrator/SKILL.md`
- 层：`orchestrator`
- 风险：`critical`
...
- 文件：`skills/b03-source-artifact-normalizer/SKILL.md`
- 层：`source-intake`
- 风险：`critical`
...
- 文件：`skills/b03-language-version-and-region-detector/SKILL.md`
- 层：`frontend-routing`
- 风险：`high`
...
- 文件：`skills/b03-build-context-and-toolchain-resolver/SKILL.md`
- 层：`build-semantics`
- 风险：`critical`
...
- 文件：`skills/b03-frontend-adapter-sdk-and-registry/SKILL.md`
- 层：`frontend-platform`
- 风险：`critical`
...
- 文件：`skills/b03-native-lossless-syntax-ir-builder/SKILL.md`
- 层：`native-ir`
- 风险：`critical`
...
- 文件：`skills/b03-native-semantic-attribution-engine/SKILL.md`
- 层：`native-semantics`
- 风险：`critical`
...
- 文件：`skills/b03-canonical-semantic-ir-schema-and-lowering/SKILL.md`
- 层：`canonical-ir`
- 风险：`critical`
...
- 文件：`skills/b03-symbol-identity-scope-and-linker/SKILL.md`
- 层：`semantic-linking`
- 风险：`critical`
...
- 文件：`skills/b03-canonical-type-system-and-language-relations/SKILL.md`
- 层：`type-system`
- 风险：`critical`
...
- 文件：`skills/b03-expression-statement-and-evaluation-order-lowerer/SKILL.md`
- 层：`semantic-lowering`
- 风险：`critical`
...
- 文件：`skills/b03-control-flow-ssa-and-dataflow-builder/SKILL.md`
- 层：`analysis-graph`
- 风险：`critical`
...
- 文件：`skills/b03-callgraph-dispatch-reflection-and-dynamic-linker/SKILL.md`
- 层：`call-analysis`
- 风险：`critical`
...
- 文件：`skills/b03-effect-exception-concurrency-and-resource-modeler/SKILL.md`
- 层：`semantic-effects`
- 风险：`critical`
...
- 文件：`skills/b03-build-config-and-resource-ir-builder/SKILL.md`
- 层：`domain-ir`
- 风险：`high`
...
- 文件：`skills/b03-api-message-and-contract-ir-builder/SKILL.md`
- 层：`contract-ir`
- 风险：`critical`
...
- 文件：`skills/b03-sql-and-database-procedural-ir-builder/SKILL.md`
- 层：`database-ir`
- 风险：`critical`
...
- 文件：`skills/b03-binary-bytecode-and-native-metadata-ir/SKILL.md`
- 层：`binary-ir`
- 风险：`critical`
...
- 文件：`skills/b03-generated-code-macro-and-metaprogramming-modeler/SKILL.md`
- 层：`provenance`
- 风险：`critical`
...
- 文件：`skills/b03-source-map-provenance-and-semantic-fingerprint/SKILL.md`
- 层：`traceability`
- 风险：`critical`
...
- 文件：`skills/b03-formalizable-core-and-proof-obligation-contract/SKILL.md`
- 层：`formal-foundation`
- 风险：`critical`
...
- 文件：`skills/b03-incremental-ir-cache-and-chunk-store/SKILL.md`
- 层：`ir-runtime`
- 风险：`critical`
...
- 文件：`skills/b03-ir-query-diff-and-export-service/SKILL.md`
- 层：`ir-service`
- 风险：`critical`
...
- 文件：`skills/b03-frontend-conformance-and-ir-certification-gate/SKILL.md`
- 层：`certification`
- 风险：`critical`
