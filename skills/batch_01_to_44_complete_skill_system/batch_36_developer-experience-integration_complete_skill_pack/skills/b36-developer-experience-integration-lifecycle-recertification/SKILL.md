...
description: "管理 draft、experimental、limited、certified、deprecated、retired、revoked 及证据过期传播。 Scope: Developer Experience, CLI, IDE and SCM Integration. Use when implementing, reviewing, or validating Batch 36."
---
## Package Metadata
