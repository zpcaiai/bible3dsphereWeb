...
description: "管理 draft、experimental、limited、certified、deprecated、retired、revoked 及证据过期传播。 Scope: Legacy Coexistence, Cutover, Hypercare and Continuous Modernization. Use when implementing, reviewing, or validating Batch 43."
---
## Package Metadata
