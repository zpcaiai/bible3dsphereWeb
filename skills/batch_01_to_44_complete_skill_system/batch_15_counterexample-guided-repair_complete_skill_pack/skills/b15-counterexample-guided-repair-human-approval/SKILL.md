...
description: "为高影响、不确定、不可逆和例外决策建立解释、审批、过期与责任边界。 Scope: Counterexample-Guided Repair and Self-Evolving Validation. Use when implementing, reviewing, or validating Batch 15."
---
## Package Metadata
