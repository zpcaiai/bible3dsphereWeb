---
name: b11-prod-semantics-lineage-reconciliation
description: "连接输入、决策、变换、输出、验证和证书，处理差异、冲突、重放和对账。 Scope: Performance, Security and Production Semantics Validation. Use when implementing, reviewing, or validating Batch 11."
---
## Package Metadata
