---
name: b11-prod-semantics-capability-planning
description: "建立能力矩阵、候选方案、约束、依赖、优先级、成本与执行计划。 Scope: Performance, Security and Production Semantics Validation. Use when implementing, reviewing, or validating Batch 11."
---
## Package Metadata
