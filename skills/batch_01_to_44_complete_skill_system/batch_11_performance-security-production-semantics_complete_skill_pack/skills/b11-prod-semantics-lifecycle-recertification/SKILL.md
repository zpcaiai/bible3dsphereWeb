---
name: b11-prod-semantics-lifecycle-recertification
description: "管理 draft、experimental、limited、certified、deprecated、retired、revoked 及证据过期传播。 Scope: Performance, Security and Production Semantics Validation. Use when implementing, reviewing, or validating Batch 11."
---
## Package Metadata
