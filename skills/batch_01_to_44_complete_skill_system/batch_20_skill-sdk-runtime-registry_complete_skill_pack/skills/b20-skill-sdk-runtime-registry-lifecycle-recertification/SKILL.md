...
description: "管理 draft、experimental、limited、certified、deprecated、retired、revoked 及证据过期传播。 Scope: Skill SDK, Runtime, Registry and Marketplace Productization. Use when implementing, reviewing, or validating Batch 20."
---
## Package Metadata
