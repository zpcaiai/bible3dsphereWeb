...
description: "落实默认拒绝、最小权限、租户隔离、Secret、供应链、隐私和策略执行。 Scope: Skill SDK, Runtime, Registry and Marketplace Productization. Use when implementing, reviewing, or validating Batch 20."
---
## Package Metadata
