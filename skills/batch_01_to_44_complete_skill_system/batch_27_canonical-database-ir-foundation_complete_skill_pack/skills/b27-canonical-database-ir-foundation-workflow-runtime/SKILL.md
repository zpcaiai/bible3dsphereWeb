...
description: "在统一 Durable Workflow 和隔离 Runner 中执行任务，管理租约、检查点、副作用和补偿。 Scope: Canonical Database IR, Data Migration and Cutover Foundation. Use when implementing, reviewing, or validating Batch 27."
---
## Package Metadata
