...
description: "管理 draft、experimental、limited、certified、deprecated、retired、revoked 及证据过期传播。 Scope: Formal Verification and Proof-Carrying Migration. Use when implementing, reviewing, or validating Batch 14."
---
## Package Metadata
