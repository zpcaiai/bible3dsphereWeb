...
description: "建设正例、负例、边界、Holdout、代表性和对抗性 Corpus，并执行基准和回归。 Scope: Formal Verification and Proof-Carrying Migration. Use when implementing, reviewing, or validating Batch 14."
---
## Package Metadata
