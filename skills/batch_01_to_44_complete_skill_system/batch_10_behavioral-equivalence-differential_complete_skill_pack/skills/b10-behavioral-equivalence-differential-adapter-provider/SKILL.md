...
description: "通过签名适配器连接语言、框架、数据库、云、工具或外部 Provider，保留能力边界。 Scope: Behavioral Equivalence, Golden Master and Differential Validation. Use when implementing, reviewing, or validating Batch 10."
---
## Package Metadata
