...
description: "建设正例、负例、边界、Holdout、代表性和对抗性 Corpus，并执行基准和回归。 Scope: Behavioral Equivalence, Golden Master and Differential Validation. Use when implementing, reviewing, or validating Batch 10."
---
## Package Metadata
