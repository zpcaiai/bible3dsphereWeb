...
description: "管理 draft、experimental、limited、certified、deprecated、retired、revoked 及证据过期传播。 Scope: Framework Modernization Execution Packs. Use when implementing, reviewing, or validating Batch 23."
---
## Package Metadata
