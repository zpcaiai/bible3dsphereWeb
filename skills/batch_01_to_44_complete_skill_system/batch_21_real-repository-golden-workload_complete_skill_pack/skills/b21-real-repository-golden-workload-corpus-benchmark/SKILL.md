...
description: "建设正例、负例、边界、Holdout、代表性和对抗性 Corpus，并执行基准和回归。 Scope: Real Repository Slice and Golden Workload Factory. Use when implementing, reviewing, or validating Batch 21."
---
## Package Metadata
