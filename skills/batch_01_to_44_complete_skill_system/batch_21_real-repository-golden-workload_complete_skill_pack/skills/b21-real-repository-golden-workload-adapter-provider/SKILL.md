...
description: "通过签名适配器连接语言、框架、数据库、云、工具或外部 Provider，保留能力边界。 Scope: Real Repository Slice and Golden Workload Factory. Use when implementing, reviewing, or validating Batch 21."
---
## Package Metadata
