...
description: "管理 draft、experimental、limited、certified、deprecated、retired、revoked 及证据过期传播。 Scope: Real Repository Slice and Golden Workload Factory. Use when implementing, reviewing, or validating Batch 21."
---
## Package Metadata
