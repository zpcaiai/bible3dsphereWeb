...
description: "定义稳定 ID、版本化 Schema、状态、输入输出、Unknown 保留、摘要和兼容策略。 Scope: Complete Project Generation Standard. Use when implementing, reviewing, or validating Batch 18."
---
## Package Metadata
