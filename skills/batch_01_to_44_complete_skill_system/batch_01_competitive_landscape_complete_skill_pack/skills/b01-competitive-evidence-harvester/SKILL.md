...
description: "把营销描述拆分为可验证原子 Claim，并保存版本、范围、来源、摘要和过期时间。 Use for Batch 01 evidence implementation, review, or validation. Use when implementing, reviewing, or validating Batch 01."
---

# b01-competitive-evidence-harvester
