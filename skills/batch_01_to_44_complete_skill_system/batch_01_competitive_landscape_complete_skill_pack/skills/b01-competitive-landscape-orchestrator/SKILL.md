...
description: "把一次性竞品调研转化为可暂停恢复、可审计、可重复运行的竞争情报与产品定位系统。 Use for Batch 01 orchestrator implementation, review, or validation. Use when implementing, reviewing, or validating Batch 01."
---

# b01-competitive-landscape-orchestrator
