...
description: "维护唯一竞争对象注册表，解决产品更名、收购、开源核心、托管平台和服务能力重复计数问题。 Use for Batch 01 registry implementation, review, or validation. Use when implementing, reviewing, or validating Batch 01."
---

# b01-competitor-discovery-registry
