...
description: "区分 Schema、SQL、Routine、Data、CDC、Dual Run、Cutover 和 Rollback，形成数据库路线竞争地图。 Use for Batch 01 database-analysis implementation, review, or validation. Use when implementing, reviewing, or validating Batch 01."
---

# b01-database-route-competitive-analyzer
...
- Batch: `batch-01`
- Capability layer: `database-analysis`
- Risk: `critical`
