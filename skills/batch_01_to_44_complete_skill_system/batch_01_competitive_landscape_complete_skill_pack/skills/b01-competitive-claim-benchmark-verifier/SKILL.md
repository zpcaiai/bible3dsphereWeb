...
description: "避免无基线、无样本、只算生成时间或删除失败测试后的误导性指标。 Use for Batch 01 validation implementation, review, or validation. Use when implementing, reviewing, or validating Batch 01."
---

# b01-competitive-claim-benchmark-verifier
