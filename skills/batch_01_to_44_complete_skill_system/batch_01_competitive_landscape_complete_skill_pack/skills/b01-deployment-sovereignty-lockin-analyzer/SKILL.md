...
description: "让客户明确源码去向、模型调用、遥测、密钥、网络出口、区域和退出成本。 Use for Batch 01 security implementation, review, or validation. Use when implementing, reviewing, or validating Batch 01."
---

# b01-deployment-sovereignty-lockin-analyzer
