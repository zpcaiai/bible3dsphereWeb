---
name: batch-01-competitive-intelligence
description: "建立可重复、可审计、可持续更新的应用现代化竞争情报、能力比较、产品定位、Battlecard 与认证体系。 Use when orchestrating, implementing, reviewing, or validating Batch 01."
---
## Package Resources
