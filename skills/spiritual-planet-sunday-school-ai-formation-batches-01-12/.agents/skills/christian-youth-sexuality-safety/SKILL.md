---
name: christian-youth-sexuality-safety
description: "Implement age-reviewed body, consent, dating, pornography exposure, sexting pressure, AI romance and help-seeking content."
---

# Goal

Youth receive truthful non-graphic safety formation without history intake, secret channels or orientation inference.
...
1. Apply age and guardian/org policy.
2. Route topics to reviewed lesson or qualified human.
3. Block graphic content and personal history prompts.
4. Explain confidentiality and protection.
5. Interrupt exploitation and danger.
