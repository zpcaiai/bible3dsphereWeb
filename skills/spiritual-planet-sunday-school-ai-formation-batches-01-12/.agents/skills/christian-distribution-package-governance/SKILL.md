---
name: christian-distribution-package-governance
description: "Implement artifact manifests, dependencies, schema compatibility, license/secret review, signatures and install/rollback guides."
---

# Goal

Each Batch and the merged suite remain reproducible, independently installable and free of duplicate Skills or leaked secrets.
...
1. Build deterministic artifact list and hashes.
2. Resolve dependencies and compatibility.
3. Run secret and license scans.
4. Generate install, upgrade and rollback guides.
5. Sign/verify using repository-approved mechanism and record decision.
