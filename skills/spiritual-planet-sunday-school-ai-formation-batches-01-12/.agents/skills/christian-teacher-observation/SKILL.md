---
name: christian-teacher-observation
description: "Implement limited teacher notes on observable participation, evidence use, help-seeking and barriers."
---

# Goal

Teachers can support learners without inferring inner spiritual or clinical states.
...
1. Use category signals and short note.
2. Define visibility and retention.
3. Block spiritual/clinical inference and ranking.
4. Escalate safety separately.
5. Apply cohort aggregation thresholds.
