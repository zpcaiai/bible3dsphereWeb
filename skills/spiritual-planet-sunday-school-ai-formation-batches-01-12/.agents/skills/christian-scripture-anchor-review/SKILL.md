---
name: christian-scripture-anchor-review
description: "Implement reference parsing, citation/translation/context/rights checks and application authority labels."
---

# Goal

Every Scripture use is traceable and reviewed rather than generated from model memory.
...
1. Reuse Batch 03 Scripture provider/guard.
2. Parse reference and citation type.
3. Load legal source or mark unverified.
4. Capture context and application claims.
5. Require theology and rights review.
