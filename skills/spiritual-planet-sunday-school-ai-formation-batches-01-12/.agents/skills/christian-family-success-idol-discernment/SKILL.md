---
name: christian-family-success-idol-discernment
description: "Implement review of grades, elite school, career, money, appearance and reputation as possible governing family priorities."
---

# Goal

Families can reorder success under faithfulness, honesty, love, worship and rest without an automated idolatry verdict.
...
1. Capture success markers and observable emotional indicators.
2. Show evidence and alternative explanations.
3. Require theology review for idolatry language.
4. Create one reordered priority and schedule change.
5. Connect to parent and family reviews.
