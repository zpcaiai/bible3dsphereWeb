---
name: christian-privacy-security-audit
description: "Implement data inventory reconciliation, tenant/RBAC tests, logging/model redaction, rights, retention and security findings."
---

# Goal

Sensitive spiritual formation data cannot ship with cross-tenant leakage, hidden logging, broken data rights or unmitigated critical findings.
...
1. Generate data-flow and inventory hash.
2. Reconcile schemas, DB, logs, analytics, model providers and caches.
3. Run tenant, owner and minor-role authorization tests.
4. Run export/delete/retention and secret-management tests.
5. Issue findings and block critical open items.
