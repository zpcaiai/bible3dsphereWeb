---
name: christian-co-parent-governance
description: "Implement adult-only shared priorities, disagreement protocol, emergency exceptions and review without child triangulation."
---

# Goal

Adult caregivers can coordinate rules without using children as messengers, allies or surveillance targets.
...
1. Resolve authorized adult participants.
2. Create shared agreement with optimistic concurrency.
3. Prevent secret edits and one-parent surveillance.
4. Support disagreement and emergency override audit.
5. Route coercive-control concerns away from ordinary collaboration.
