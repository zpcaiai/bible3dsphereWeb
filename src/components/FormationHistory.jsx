      ...
      {items.map((e) => {
        ...
        return (
          <div key={e.id} onClick={clickable ? () => onOpen(e.refId) : undefined}
            style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 12, padding: '11px 13px', marginBottom: 8, cursor: clickable ? 'pointer' : 'default' }} {...a11yClickProps(clickable ? () => onOpen(e.refId) : undefined)}>
