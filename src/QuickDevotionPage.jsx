...
export default function QuickDevotionPage({ user, token, onBack, onDone }) {
  ...
  async function handleFinish() {
    ...
    try {
      ...
      writePlanExecution(window.localStorage, planExecutionIdentity(user), 'quick-devotion', QUICK_DEVOTION_ACTION, { status: 'completed', reflection: questionAnswer.trim() })
      setSaved(true)
  ...
  const completionSummary = planExecutionSummary(window.localStorage, planExecutionIdentity(user), 'quick-devotion', [QUICK_DEVOTION_ACTION])
