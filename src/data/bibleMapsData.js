...
const david = {
  id: 'david',
  title: '大卫王统一王国地图',
  subtitle: '核心疆域、鼎盛军事与藩属势力范围',
  era: '约公元前 1010–970',
  badge: '★★★★★',
  bounds: { minLng: 33.5, maxLng: 38.9, minLat: 29.2, maxLat: 35.7 },
  mode: 'journey',
  layerSelect: 'multi',
  regions: [
    {
      ...
      color: '#fb7185',
      center: [36.55, 33.10],
      polygon: [[34.20, 31.05], [34.55, 32.70], [35.58, 34.55], [38.45, 35.15], [38.62, 34.35], [36.35, 32.55], [36.08, 30.25], [35.05, 29.38], [34.20, 31.05]],
      note: '大卫王国鼎盛时期的军事与藩属势力进一步北达亚兰、大马士革、琐巴、哈马口乃至幼发拉底河方向，南控以东和亚拉巴谷直到红海亚喀巴湾北端，东服摩押、亚扪，西压非利士五城；推罗、西顿一带多属友好腓尼基城邦，并非直接统治区。',
    },
    {
      id: 'david-core',
      label: '以色列核心疆域',
      ...
      note: '大卫王国核心疆域以耶路撒冷为中心，西抵地中海沿岸及非利士平原，东跨约旦河至基列、巴珊、流便、迦得和玛拿西半支派地，北至但、加利利北部和黑门山南麓，南至别是巴和南地。',
    },
    {
      id: 'david-philistia',
      label: '非利士沿海',
      ...
      note: '鼎盛时期大卫西压非利士五城，控制非利士平原的军事主动权；沿海腓尼基的推罗、西顿多为友好城邦关系，并非直接统治区。',
    },
    {
      id: 'david-east',
      label: '摩押·亚扪·以东',
      ...
      note: '鼎盛时期大卫东服摩押、亚扪，南控以东和亚拉巴谷直到红海亚喀巴湾北端。',
    },
    {
      id: 'david-aram',
      label: '亚兰/大马士革势力范围',
      ...
      note: '大卫鼎盛时期的北方军事与藩属势力达亚兰、大马士革、琐巴、哈马口乃至幼发拉底河方向。',
    },
  ],
  boundaries: [
  ...
  regions: [
    {
      ...
      note: '所罗门王国以耶路撒冷为政治与宗教中心，核心疆域覆盖迦南地、约旦河西岸和约旦河东的基列、巴珊等地区。其北界以但、加利利北部、黑门山南麓为核心；南界从别是巴、南地延伸至以东、亚拉巴谷和红海北端的以旬迦别。',
    },
    {
      ...
      note: '所罗门王国的影响力向哈马口、亚兰、大马士革和幼发拉底河方向延伸；东界跨越约旦河，控制或影响摩押、亚扪、亚兰旷野边缘及东方商路；西界抵达地中海沿岸及非利士平原。',
    },
    {
      ...
      note: '整体上，所罗门王国不是单纯的本土疆域，而是由核心领土、藩属地区、贸易通道和盟友网络共同构成的区域性帝国；红海以旬迦别、俄斐贸易线、东方商路，以及与推罗、西顿等腓尼基城邦的结盟共同支撑其黄金时代。',
    },
  ],
  boundaries: [
...
const characters = {
  ...
  layers: [
    ...
    { id: 'c-moses', label: '摩西', color: '#5ec2e8', route: true, era: '约公元前 1526–1406', scene: 'tablets', bio: '以色列的领袖与立法者。在荆棘火焰中蒙召，领以色列出埃及、过红海，在西奈山领受十诫与律法，带领百姓走过旷野四十年。', points: [
      { id: 'cm-1', name_zh: '埃及歌珊地', name_en: 'Goshen', lng: 31.82, lat: 30.79, order: 1, confidence: 'approximate', scriptureRef: '出1:7', events: [{ title: '以色列人在歌珊地增多', ref: '出1:7', summary: '以色列人在歌珊地增多，摩西出生在埃及压迫背景中。' }] },
      { id: 'cm-2', name_zh: '尼罗河', name_en: 'Nile River', lng: 31.05, lat: 30.85, order: 2, confidence: 'approximate', scriptureRef: '出2:3', events: [{ title: '婴孩摩西被放在蒲草箱中', ref: '出2:3', summary: '婴孩摩西被放在蒲草箱中，漂在河边芦荻中。' }] },
      { id: 'cm-3', name_zh: '法老王宫', name_en: 'Pharaoh Palace', lng: 31.25, lat: 29.85, order: 3, confidence: 'approximate', scriptureRef: '出2:10', events: [{ title: '法老女儿收养摩西', ref: '出2:10', summary: '法老女儿收养摩西，他在埃及宫廷长大。' }] },
      { id: 'cm-4', name_zh: '米甸', name_en: 'Midian', lng: 35.0, lat: 28.6, order: 4, confidence: 'approximate', scriptureRef: '出2:15', events: [{ title: '摩西逃往米甸', ref: '出2:15', summary: '摩西逃往米甸，娶西坡拉并牧养叶忒罗的羊群。' }] },
      { id: 'cm-5', name_zh: '何烈山', name_en: 'Horeb', lng: 33.974, lat: 28.539, order: 5, confidence: 'approximate', scriptureRef: '出3:1', events: [{ title: '在焚而不毁的荆棘中蒙召', ref: '出3:1', summary: '在焚而不毁的荆棘中蒙召，被差回埃及。' }] },
      { id: 'cm-6', name_zh: '埃及', name_en: 'Egypt', lng: 31.236, lat: 30.044, order: 6, confidence: 'approximate', scriptureRef: '出5:1', events: [{ title: '回到埃及面对法老', ref: '出5:1', summary: '回到埃及面对法老，宣告耶和华要释放祂的百姓。' }] },
      { id: 'cm-7', name_zh: '兰塞', name_en: 'Rameses', lng: 31.82, lat: 30.79, order: 7, confidence: 'approximate', scriptureRef: '出12:37', events: [{ title: '以色列人从兰塞起行', ref: '出12:37', summary: '以色列人从兰塞起行，正式出埃及。' }] },
      { id: 'cm-8', name_zh: '疏割', name_en: 'Succoth', lng: 32.1, lat: 30.57, order: 8, confidence: 'approximate', scriptureRef: '出12:37', events: [{ title: '出埃及后第一站', ref: '出12:37', summary: '出埃及后第一站，百姓从奴役地踏上旷野路。' }] },
      { id: 'cm-9', name_zh: '以倘', name_en: 'Etham', lng: 32.32, lat: 30.42, order: 9, confidence: 'approximate', scriptureRef: '出13:20', events: [{ title: '在旷野边安营', ref: '出13:20', summary: '在旷野边安营，云柱火柱引导前路。' }] },
      { id: 'cm-10', name_zh: '红海', name_en: 'Red Sea', lng: 32.55, lat: 29.95, order: 10, confidence: 'approximate', scriptureRef: '出14:21', events: [{ title: '耶和华分开海水', ref: '出14:21', summary: '耶和华分开海水，使以色列人走干地过去。' }] },
      { id: 'cm-11', name_zh: '书珥旷野', name_en: 'Wilderness of Shur', lng: 33.0, lat: 29.75, order: 11, confidence: 'approximate', scriptureRef: '出15:22', events: [{ title: '过海后进入书珥旷野', ref: '出15:22', summary: '过海后进入书珥旷野，走了三天找不着水。' }] },
      { id: 'cm-12', name_zh: '玛拉', name_en: 'Marah', lng: 33.25, lat: 29.35, order: 12, confidence: 'approximate', scriptureRef: '出15:23', events: [{ title: '苦水变甜', ref: '出15:23', summary: '苦水变甜，百姓学习听从耶和华。' }] },
      { id: 'cm-13', name_zh: '以琳', name_en: 'Elim', lng: 33.37, lat: 29.2, order: 13, confidence: 'approximate', scriptureRef: '出15:27', events: [{ title: '十二股水泉、七十棵棕树', ref: '出15:27', summary: '十二股水泉、七十棵棕树，成为旷野中的供应站。' }] },
      { id: 'cm-14', name_zh: '汛的旷野', name_en: 'Wilderness of Sin', lng: 33.55, lat: 29.05, order: 14, confidence: 'approximate', scriptureRef: '出16:1', events: [{ title: '百姓发怨言', ref: '出16:1', summary: '百姓发怨言，耶和华赐下吗哪与鹌鹑。' }] },
      { id: 'cm-15', name_zh: '利非订', name_en: 'Rephidim', lng: 33.72, lat: 28.72, order: 15, confidence: 'approximate', scriptureRef: '出17:1', events: [{ title: '磐石出水', ref: '出17:1', summary: '磐石出水，又与亚玛力争战。' }] },
      { id: 'cm-16', name_zh: '西奈山', name_en: 'Mount Sinai', lng: 33.974, lat: 28.539, order: 16, confidence: 'approximate', scriptureRef: '出19:2', events: [{ title: '在西奈山下领受律法、圣约与会幕启示', ref: '出19:2', summary: '在西奈山下领受律法、圣约与会幕启示。' }] },
      { id: 'cm-17', name_zh: '巴兰旷野', name_en: 'Wilderness of Paran', lng: 34.3, lat: 30.0, order: 17, confidence: 'approximate', scriptureRef: '民10:12', events: [{ title: '离开西奈后进入巴兰旷野', ref: '民10:12', summary: '离开西奈后进入巴兰旷野，向应许地推进。' }] },
      { id: 'cm-18', name_zh: '加低斯巴尼亚', name_en: 'Kadesh Barnea', lng: 34.43, lat: 30.64, order: 18, confidence: 'approximate', scriptureRef: '民13:26', events: [{ title: '探子回报', ref: '民13:26', summary: '探子回报，百姓因不信而转入漫长漂流。' }] },
      { id: 'cm-19', name_zh: '旷野漂流', name_en: 'Wilderness Wandering', lng: 34.8, lat: 30.2, order: 19, confidence: 'approximate', scriptureRef: '民14:33', events: [{ title: '四十年在旷野漂流', ref: '民14:33', summary: '四十年在旷野漂流，旧一代倒毙，新一代被预备。' }] },
      { id: 'cm-20', name_zh: '何珥山', name_en: 'Mount Hor', lng: 35.41, lat: 30.32, order: 20, confidence: 'approximate', scriptureRef: '民20:22-29', events: [{ title: '亚伦在何珥山离世', ref: '民20:22-29', summary: '亚伦在何珥山离世，祭司职分交给以利亚撒。' }] },
      { id: 'cm-21', name_zh: '亚嫩谷', name_en: 'Arnon Valley', lng: 35.75, lat: 31.43, order: 21, confidence: 'approximate', scriptureRef: '民21:13', events: [{ title: '以色列到亚嫩河谷', ref: '民21:13', summary: '以色列到亚嫩河谷，进入约旦河东边界地带。' }] },
      { id: 'cm-22', name_zh: '希实本', name_en: 'Heshbon', lng: 35.81, lat: 31.8, order: 22, confidence: 'approximate', scriptureRef: '民21:25', events: [{ title: '击败亚摩利王西宏', ref: '民21:25', summary: '击败亚摩利王西宏，占取希实本。' }] },
      { id: 'cm-23', name_zh: '巴珊', name_en: 'Bashan', lng: 36.0, lat: 32.7, order: 23, confidence: 'approximate', scriptureRef: '民21:33', events: [{ title: '击败巴珊王噩', ref: '民21:33', summary: '击败巴珊王噩，取得约旦河东北部。' }] },
      { id: 'cm-24', name_zh: '摩押平原', name_en: 'Plains of Moab', lng: 35.62, lat: 31.82, order: 24, confidence: 'approximate', scriptureRef: '民22:1', events: [{ title: '在耶利哥对面的摩押平原安营', ref: '民22:1', summary: '在耶利哥对面的摩押平原安营，预备进入迦南。' }] },
      { id: 'cm-25', name_zh: '尼波山', name_en: 'Mount Nebo', lng: 35.73, lat: 31.77, order: 25, confidence: 'approximate', scriptureRef: '申34:1', events: [{ title: '摩西登尼波山遥望应许地', ref: '申34:1', summary: '摩西登尼波山遥望应许地，随后离世。' }] },
    ] },
    { id: 'c-david', label: '大卫', color: '#ff6b6b', route: true, era: '约公元前 1040–970', scene: 'crown', bio: '合神心意的牧人君王。从伯利恒牧场受膏，凭信心击杀歌利亚，建都耶路撒冷；神应许他的国位坚立到永远。诗篇多出其手。', points: [
      { id: 'cd-1', name_zh: '伯利恒', name_en: 'Bethlehem', lng: 35.202, lat: 31.705, order: 1, confidence: 'approximate', scriptureRef: '撒上16:13', events: [{ title: '被撒母耳膏立', ref: '撒上16:13', summary: '被撒母耳膏立。' }] },
      { id: 'cd-2', name_zh: '基比亚/扫罗王宫', name_en: 'Gibeah / Saul Court', lng: 35.22, lat: 31.82, order: 2, confidence: 'approximate', scriptureRef: '撒上16:21', events: [{ title: '进扫罗宫廷弹琴服事', ref: '撒上16:21', summary: '进扫罗宫廷弹琴服事，并成为拿兵器的人。' }] },
      { id: 'cd-3', name_zh: '以拉谷', name_en: 'Valley of Elah', lng: 34.98, lat: 31.69, order: 3, confidence: 'approximate', scriptureRef: '撒上17:49', events: [{ title: '靠耶和华的名击败歌利亚', ref: '撒上17:49', summary: '靠耶和华的名击败歌利亚。' }] },
      { id: 'cd-4', name_zh: '拉玛/拿约', name_en: 'Ramah / Naioth', lng: 35.18, lat: 31.85, order: 4, confidence: 'approximate', scriptureRef: '撒上19:18', events: [{ title: '逃到拉玛见撒母耳', ref: '撒上19:18', summary: '逃到拉玛见撒母耳，同住拿约；扫罗差人都受感说话。' }] },
      { id: 'cd-5', name_zh: '挪伯', name_en: 'Nob', lng: 35.25, lat: 31.83, order: 5, confidence: 'approximate', scriptureRef: '撒上21:1', events: [{ title: '向祭司亚希米勒求饼和歌利亚的刀', ref: '撒上21:1', summary: '向祭司亚希米勒求饼和歌利亚的刀。' }] },
      { id: 'cd-6', name_zh: '迦特', name_en: 'Gath', lng: 34.85, lat: 31.61, order: 6, confidence: 'approximate', scriptureRef: '撒上21:10', events: [{ title: '逃到非利士王亚吉那里', ref: '撒上21:10', summary: '逃到非利士王亚吉那里，装疯脱险。' }] },
      { id: 'cd-7', name_zh: '亚杜兰洞', name_en: 'Adullam Cave', lng: 34.96, lat: 31.65, order: 7, confidence: 'approximate', scriptureRef: '撒上22:1', events: [{ title: '困苦、欠债、心里苦恼的人聚集到他那里', ref: '撒上22:1', summary: '困苦、欠债、心里苦恼的人聚集到他那里。' }] },
      { id: 'cd-8', name_zh: '摩押的米斯巴', name_en: 'Mizpeh of Moab', lng: 35.78, lat: 31.72, order: 8, confidence: 'approximate', scriptureRef: '撒上22:3', events: [{ title: '把父母托付给摩押王照顾', ref: '撒上22:3', summary: '把父母托付给摩押王照顾。' }] },
      { id: 'cd-9', name_zh: '哈列树林', name_en: 'Forest of Hereth', lng: 35.05, lat: 31.45, order: 9, confidence: 'approximate', scriptureRef: '撒上22:5', events: [{ title: '照先知迦得的话回到犹大地', ref: '撒上22:5', summary: '照先知迦得的话回到犹大地。' }] },
      { id: 'cd-10', name_zh: '基伊拉', name_en: 'Keilah', lng: 35.0, lat: 31.62, order: 10, confidence: 'approximate', scriptureRef: '撒上23:5', events: [{ title: '救基伊拉脱离非利士人', ref: '撒上23:5', summary: '救基伊拉脱离非利士人，却仍需逃避扫罗。' }] },
      { id: 'cd-11', name_zh: '西弗旷野', name_en: 'Wilderness of Ziph', lng: 35.12, lat: 31.48, order: 11, confidence: 'approximate', scriptureRef: '撒上23:14', events: [{ title: '在山寨中躲避扫罗天天的追索', ref: '撒上23:14', summary: '在山寨中躲避扫罗天天的追索。' }] },
      { id: 'cd-12', name_zh: '何列沙', name_en: 'Horesh', lng: 35.11, lat: 31.46, order: 12, confidence: 'approximate', scriptureRef: '撒上23:16', events: [{ title: '约拿单到树林里坚固他的手', ref: '撒上23:16', summary: '约拿单到树林里坚固他的手，使他倚靠神。' }] },
      { id: 'cd-13', name_zh: '玛云旷野', name_en: 'Wilderness of Maon', lng: 35.13, lat: 31.41, order: 13, confidence: 'approximate', scriptureRef: '撒上23:24', events: [{ title: '扫罗追逼', ref: '撒上23:24', summary: '扫罗追逼，大卫几乎被围住。' }] },
      { id: 'cd-14', name_zh: '隐基底', name_en: 'En Gedi', lng: 35.389, lat: 31.461, order: 14, confidence: 'approximate', scriptureRef: '撒上24:1', events: [{ title: '在洞中不伸手害耶和华的受膏者', ref: '撒上24:1', summary: '在洞中不伸手害耶和华的受膏者。' }] },
      { id: 'cd-15', name_zh: '巴兰旷野', name_en: 'Wilderness of Paran', lng: 34.3, lat: 30.0, order: 15, confidence: 'approximate', scriptureRef: '撒上25:1', events: [{ title: '撒母耳死后', ref: '撒上25:1', summary: '撒母耳死后，大卫下到巴兰旷野。' }] },
      { id: 'cd-16', name_zh: '迦密', name_en: 'Carmel', lng: 35.13, lat: 31.43, order: 16, confidence: 'approximate', scriptureRef: '撒上25:2', events: [{ title: '拿八与亚比该事件显明大卫受拦阻不亲手', ref: '撒上25:2', summary: '拿八与亚比该事件显明大卫受拦阻不亲手报仇。' }] },
      { id: 'cd-17', name_zh: '西弗旷野/哈基拉山', name_en: 'Hill of Hachilah', lng: 35.15, lat: 31.47, order: 17, confidence: 'approximate', scriptureRef: '撒上26:5', events: [{ title: '夜入扫罗营中取走枪和水瓶', ref: '撒上26:5', summary: '夜入扫罗营中取走枪和水瓶，再次不害受膏者。' }] },
      { id: 'cd-18', name_zh: '迦特', name_en: 'Gath', lng: 34.85, lat: 31.61, order: 18, confidence: 'approximate', scriptureRef: '撒上27:2', events: [{ title: '再次投奔迦特王亚吉', ref: '撒上27:2', summary: '再次投奔迦特王亚吉。' }] },
      { id: 'cd-19', name_zh: '洗革拉', name_en: 'Ziklag', lng: 34.85, lat: 31.39, order: 19, confidence: 'approximate', scriptureRef: '撒上27:6', events: [{ title: '寄居非利士地', ref: '撒上27:6', summary: '寄居非利士地，后来从洗革拉得知扫罗战死。' }] },
      { id: 'cd-20', name_zh: '希伯仑', name_en: 'Hebron', lng: 35.099, lat: 31.532, order: 20, confidence: 'approximate', scriptureRef: '撒下2:4', events: [{ title: '受膏作犹大家的王', ref: '撒下2:4', summary: '受膏作犹大家的王。' }] },
      { id: 'cd-21', name_zh: '基遍池旁', name_en: 'Pool of Gibeon', lng: 35.184, lat: 31.846, order: 21, confidence: 'approximate', scriptureRef: '撒下2:13', events: [{ title: '约押与押尼珥在基遍池旁对阵', ref: '撒下2:13', summary: '约押与押尼珥在基遍池旁对阵，两家争战的开端。' }] },
      { id: 'cd-22', name_zh: '希伯仑', name_en: 'Hebron', lng: 35.099, lat: 31.532, order: 22, confidence: 'approximate', scriptureRef: '撒下5:1-3', events: [{ title: '以色列众支派来希伯仑膏大卫作全以色列', ref: '撒下5:1-3', summary: '以色列众支派来希伯仑膏大卫作全以色列的王。' }] },
      { id: 'cd-23', name_zh: '耶路撒冷/锡安', name_en: 'Jerusalem / Zion', lng: 35.214, lat: 31.768, order: 23, confidence: 'approximate', scriptureRef: '撒下5:7', events: [{ title: '攻取锡安保障', ref: '撒下5:7', summary: '攻取锡安保障，建立大卫城。' }] },
      { id: 'cd-24', name_zh: '巴力毗拉心', name_en: 'Baal Perazim', lng: 35.15, lat: 31.78, order: 24, confidence: 'approximate', scriptureRef: '撒下5:20', events: [{ title: '击败非利士人', ref: '撒下5:20', summary: '击败非利士人，称耶和华如水冲去敌人。' }] },
      { id: 'cd-25', name_zh: '利乏音谷', name_en: 'Valley of Rephaim', lng: 35.18, lat: 31.74, order: 25, confidence: 'approximate', scriptureRef: '撒下5:22', events: [{ title: '再次与非利士人争战', ref: '撒下5:22', summary: '再次与非利士人争战，照神指示行动。' }] },
      { id: 'cd-26', name_zh: '基列耶琳', name_en: 'Kiriath-jearim', lng: 35.1, lat: 31.8, order: 26, confidence: 'approximate', scriptureRef: '撒下6:2', events: [{ title: '从亚比拿达家迎约柜', ref: '撒下6:2', summary: '从亚比拿达家迎约柜。' }] },
      { id: 'cd-27', name_zh: '拿艮禾场', name_en: 'Threshing Floor of Nacon', lng: 35.16, lat: 31.79, order: 27, confidence: 'approximate', scriptureRef: '撒下6:6', events: [{ title: '乌撒伸手扶约柜被击杀', ref: '撒下6:6', summary: '乌撒伸手扶约柜被击杀，大卫惧怕，约柜改道。' }] },
      { id: 'cd-28', name_zh: '俄别以东家', name_en: 'House of Obed-edom', lng: 35.13, lat: 31.79, order: 28, confidence: 'approximate', scriptureRef: '撒下6:10', events: [{ title: '约柜暂放三个月', ref: '撒下6:10', summary: '约柜暂放三个月，耶和华赐福俄别以东家。' }] },
      { id: 'cd-29', name_zh: '耶路撒冷', name_en: 'Jerusalem', lng: 35.214, lat: 31.768, order: 29, confidence: 'approximate', scriptureRef: '撒下6:12', events: [{ title: '欢欢喜喜将约柜迎入大卫城', ref: '撒下6:12', summary: '欢欢喜喜将约柜迎入大卫城。' }] },
      { id: 'cd-30', name_zh: '拉巴', name_en: 'Rabbah', lng: 35.93, lat: 31.95, order: 30, confidence: 'approximate', scriptureRef: '撒下12:29', events: [{ title: '攻取亚扪人的京城拉巴', ref: '撒下12:29', summary: '攻取亚扪人的京城拉巴。' }] },
      { id: 'cd-31', name_zh: '橄榄山', name_en: 'Mount of Olives', lng: 35.243, lat: 31.778, order: 31, confidence: 'approximate', scriptureRef: '撒下15:30', events: [{ title: '押沙龙叛乱时蒙头赤脚上橄榄山哭泣', ref: '撒下15:30', summary: '押沙龙叛乱时蒙头赤脚上橄榄山哭泣。' }] },
      { id: 'cd-32', name_zh: '巴户琳', name_en: 'Bahurim', lng: 35.27, lat: 31.82, order: 32, confidence: 'approximate', scriptureRef: '撒下16:5', events: [{ title: '示每咒骂大卫', ref: '撒下16:5', summary: '示每咒骂大卫，大卫忍受管教与羞辱。' }] },
      { id: 'cd-33', name_zh: '约旦河渡口', name_en: 'Jordan Crossing', lng: 35.53, lat: 31.87, order: 33, confidence: 'approximate', scriptureRef: '撒下17:22', events: [{ title: '得密报连夜过约旦河', ref: '撒下17:22', summary: '得密报连夜过约旦河，到了天亮无一人未过。' }] },
      { id: 'cd-34', name_zh: '玛哈念', name_en: 'Mahanaim', lng: 35.72, lat: 32.2, order: 34, confidence: 'approximate', scriptureRef: '撒下17:24', events: [{ title: '逃到约旦河东玛哈念', ref: '撒下17:24', summary: '逃到约旦河东玛哈念，重整局势。' }] },
      { id: 'cd-35', name_zh: '以法莲树林', name_en: 'Forest of Ephraim', lng: 35.72, lat: 32.08, order: 35, confidence: 'approximate', scriptureRef: '撒下18:6', events: [{ title: '押沙龙军队败在以法莲树林', ref: '撒下18:6', summary: '押沙龙军队败在以法莲树林。' }] },
      { id: 'cd-36', name_zh: '吉甲', name_en: 'Gilgal', lng: 35.5, lat: 31.86, order: 36, confidence: 'approximate', scriptureRef: '撒下19:15', events: [{ title: '众人到吉甲迎王过约旦河', ref: '撒下19:15', summary: '众人到吉甲迎王过约旦河。' }] },
      { id: 'cd-37', name_zh: '耶路撒冷', name_en: 'Jerusalem', lng: 35.214, lat: 31.768, order: 37, confidence: 'approximate', scriptureRef: '撒下19:40', events: [{ title: '大卫回到耶路撒冷', ref: '撒下19:40', summary: '大卫回到耶路撒冷，继续作王。' }] },
      { id: 'cd-38', name_zh: '基训泉', name_en: 'Gihon Spring', lng: 35.2362, lat: 31.7733, order: 38, confidence: 'approximate', scriptureRef: '王上1:38-39', events: [{ title: '所罗门在基训受膏作王', ref: '王上1:38-39', summary: '所罗门在基训受膏作王，国位得以坚立。' }] },
      { id: 'cd-39', name_zh: '大卫城', name_en: 'City of David', lng: 35.2354, lat: 31.7735, order: 39, confidence: 'approximate', scriptureRef: '王上2:10', events: [{ title: '大卫与列祖同睡', ref: '王上2:10', summary: '大卫与列祖同睡，葬在大卫城。' }] },
    ] },
    { id: 'c-elijah', label: '以利亚', color: '#4ade80', route: true, era: '约公元前 9 世纪', scene: 'fire', bio: '烈火先知。在亚哈王拜巴力的黑暗年代为耶和华争战，于迦密山求火降下证明真神，最终乘旋风火车被接升天。', points: [
      { id: 'ce-1', name_zh: '基列的提斯比', name_en: 'Tishbe in Gilead', lng: 35.75, lat: 32.44, order: 1, confidence: 'approximate', scriptureRef: '王上17:1', events: [{ title: '以利亚出身基列寄居者', ref: '王上17:1', summary: '以利亚出身基列寄居者，忽然站在亚哈面前。' }] },
      { id: 'ce-2', name_zh: '撒玛利亚/亚哈面前', name_en: 'Samaria / Before Ahab', lng: 35.2, lat: 32.28, order: 2, confidence: 'approximate', scriptureRef: '王上17:1', events: [{ title: '向亚哈宣告若非他祷告', ref: '王上17:1', summary: '向亚哈宣告若非他祷告，几年不降露不下雨。' }] },
      { id: 'ce-3', name_zh: '基立溪', name_en: 'Cherith Brook', lng: 35.5, lat: 31.95, order: 3, confidence: 'approximate', scriptureRef: '王上17:3', events: [{ title: '藏在约旦河东边', ref: '王上17:3', summary: '藏在约旦河东边，乌鸦按时供养。' }] },
      { id: 'ce-4', name_zh: '撒勒法', name_en: 'Zarephath', lng: 35.29, lat: 33.45, order: 4, confidence: 'approximate', scriptureRef: '王上17:9', events: [{ title: '寡妇的面与油不断', ref: '王上17:9', summary: '寡妇的面与油不断，并经历孩子复活。' }] },
      { id: 'ce-5', name_zh: '迦密山', name_en: 'Mount Carmel', lng: 35.05, lat: 32.73, order: 5, confidence: 'approximate', scriptureRef: '王上18:20', events: [{ title: '召聚以色列和巴力先知', ref: '王上18:20', summary: '召聚以色列和巴力先知，显明耶和华是神。' }] },
      { id: 'ce-6', name_zh: '基顺河', name_en: 'Kishon Brook', lng: 35.08, lat: 32.7, order: 6, confidence: 'approximate', scriptureRef: '王上18:40', events: [{ title: '在基顺河边处置巴力先知', ref: '王上18:40', summary: '在基顺河边处置巴力先知。' }] },
      { id: 'ce-7', name_zh: '耶斯列', name_en: 'Jezreel', lng: 35.32, lat: 32.56, order: 7, confidence: 'approximate', scriptureRef: '王上18:46', events: [{ title: '耶和华的灵降在他身上', ref: '王上18:46', summary: '耶和华的灵降在他身上，奔在亚哈前头直到耶斯列。' }] },
      { id: 'ce-8', name_zh: '别是巴', name_en: 'Beersheba', lng: 34.791, lat: 31.252, order: 8, confidence: 'approximate', scriptureRef: '王上19:3', events: [{ title: '因耶洗别威胁逃走', ref: '王上19:3', summary: '因耶洗别威胁逃走，将仆人留在别是巴。' }] },
      { id: 'ce-9', name_zh: '旷野罗腾树下', name_en: 'Broom Tree in Wilderness', lng: 34.9, lat: 30.95, order: 9, confidence: 'approximate', scriptureRef: '王上19:4', events: [{ title: '在旷野罗腾树下求死', ref: '王上19:4', summary: '在旷野罗腾树下求死，却被天使供应。' }] },
      { id: 'ce-10', name_zh: '何烈山', name_en: 'Horeb', lng: 33.974, lat: 28.539, order: 10, confidence: 'approximate', scriptureRef: '王上19:8', events: [{ title: '到神的山', ref: '王上19:8', summary: '到神的山，在微小声音中重新受差遣。' }] },
      { id: 'ce-11', name_zh: '亚伯米何拉', name_en: 'Abel-meholah', lng: 35.53, lat: 32.33, order: 11, confidence: 'approximate', scriptureRef: '王上19:16', events: [{ title: '呼召以利沙跟随', ref: '王上19:16', summary: '呼召以利沙跟随，承接先知职分。' }] },
      { id: 'ce-12', name_zh: '耶斯列', name_en: 'Jezreel', lng: 35.32, lat: 32.56, order: 12, confidence: 'approximate', scriptureRef: '王上21:17', events: [{ title: '因拿伯葡萄园事件宣告亚哈家的审判', ref: '王上21:17', summary: '因拿伯葡萄园事件宣告亚哈家的审判。' }] },
      { id: 'ce-13', name_zh: '撒玛利亚', name_en: 'Samaria', lng: 35.2, lat: 32.28, order: 13, confidence: 'approximate', scriptureRef: '王下1:3', events: [{ title: '责备亚哈谢求问巴力西卜', ref: '王下1:3', summary: '责备亚哈谢求问巴力西卜，不求问以色列的神。' }] },
      { id: 'ce-14', name_zh: '吉甲', name_en: 'Gilgal', lng: 35.5, lat: 31.86, order: 14, confidence: 'approximate', scriptureRef: '王下2:1', events: [{ title: '最后旅程从吉甲出发', ref: '王下2:1', summary: '最后旅程从吉甲出发，以利沙紧紧跟随。' }] },
      { id: 'ce-15', name_zh: '伯特利', name_en: 'Bethel', lng: 35.22, lat: 31.93, order: 15, confidence: 'approximate', scriptureRef: '王下2:2', events: [{ title: '到伯特利', ref: '王下2:2', summary: '到伯特利，先知门徒知道以利亚将被接走。' }] },
      { id: 'ce-16', name_zh: '耶利哥', name_en: 'Jericho', lng: 35.444, lat: 31.872, order: 16, confidence: 'approximate', scriptureRef: '王下2:4', events: [{ title: '到耶利哥', ref: '王下2:4', summary: '到耶利哥，继续向约旦河前行。' }] },
      { id: 'ce-17', name_zh: '约旦河', name_en: 'Jordan River', lng: 35.55, lat: 31.84, order: 17, confidence: 'approximate', scriptureRef: '王下2:8', events: [{ title: '以外衣打水', ref: '王下2:8', summary: '以外衣打水，水左右分开，二人走干地而过。' }] },
      { id: 'ce-18', name_zh: '约旦河东升天之地', name_en: 'East of Jordan Ascension Site', lng: 35.6, lat: 31.86, order: 18, confidence: 'approximate', scriptureRef: '王下2:11', events: [{ title: '火车火马隔开二人', ref: '王下2:11', summary: '火车火马隔开二人，以利亚乘旋风升天。' }] },
    ] },
